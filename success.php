...
<head>
	...
	<noscript><img height="1" width="1" style="display:none"
			src="https://www.facebook.com/tr?id=<?=$fbpxid?>&ev=PageView&noscript=1" /></noscript>
	<script>
		fbq('track', 'Lead');
	</script>
	...
	<div class="container">
		<div class="row">
			<div class="page-header">
				...
				<span>Наш менеджер перезвонит Вам в течение 15 минут по номеру: <br>
					<strong><?php if(isset($_GET['phone'])) {echo '+',trim($_GET['phone']);} ?></strong>
				</span>
				<div class="line"><img src="success_img/thankyou-divider.png" alt=""></div>
				<span style="font-size: 18px">
					Если вы ошиблись при заполнении формы, заполните заявку еще раз
					<a class="back--link" href="javascript: history.back(-1);">Вернуться</a>
				</span>
			</div>
		</div>
	</div>
